...
async function getpayrollValues(){
    try{
        ...
        let payroll = await pool.request().query("select EMPCODE,Employee_Name,COUNT(EMPCODE) as work_Days,PO_NUM,CCODE,CNAME from employee_attendance  where Shift_date>'2020-12-31' group by EMPCODE,Employee_Name,PO_NUM,PO_NUM,CCODE,CNAME");
